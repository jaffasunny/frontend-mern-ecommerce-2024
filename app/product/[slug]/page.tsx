...
import { TGetSingleProductAPI, TUserType } from "@/types";
import { GetSingleProductAPI } from "@/utils/Apis";
...
const Product = (props: Props) => {
	...
	const [product, setProduct] = useState<TGetSingleProductAPI["data"]>({
		_id: "",
		image: "",
		productName: "",
		description: "",
	...
	const GetSingleProduct = useMemo(
		() => async () => {
			try {
				setIsLoading(true);
				...
				if (response?.message === "Access token refreshed successfully!") {
					const _response = response as TUserType;
					storeRefreshAccessToken(_response.data);
				}
				...
				{isLoading ? (
					...
					<>
						...
						<div className='lg:w-4/5 mx-auto flex flex-wrap'>
							<img
								alt='ecommerce'
								className='lg:w-1/2 w-full lg:h-auto h-64 object-contain object-center rounded mix-blend-multiply'
							...
							<div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
								...
								<h1 className='text-gray-900 text-3xl title-font font-medium mb-1'>
									{product.productName || "The Catcher in the Rye"}
								</h1>
