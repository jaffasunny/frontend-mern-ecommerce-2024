		...
		<nav
			...
			<div
				...
				<div className='flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7'>
					<a
						className='font-regular text-blue-600 md:py-6 dark:text-blue-500'
						href='#'
						aria-current='page'>
						Landing
					</a>
					<a
						className='font-regular text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500'
						href='#'>
						Account
					</a>
					<a
					...
					<div className='hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4'>
						<button
							type='button'
							className='flex items-center w-full text-gray-500 hover:text-gray-400 font-regular dark:text-gray-400 dark:hover:text-gray-500 '>
							Dropdown
							<svg
